...
package com.example.android.androidapp.FunctiiPerformanta.Functie1;
...
public class MainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    public static final String PREFERENCES_NAME = "com.assistentapp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.perform_functie1);
